...
LOCAL_INCLUDES := $(MM_INCLUDE)                        \
                  $(SRC_PATH)                          \
                  $(SRC_PATH)/components               \
                  $(MM_MEDIACODEC_INCLUDE)    # for ByteBuffer defined by media_codec_common.h

LOCAL_SRC_FILES := $(SRC_PATH)/components/v4l2codec_device.cc  \
                   $(SRC_PATH)/components/video_decode_v4l2.cc \
                   $(SRC_PATH)/make_csd.cc
...
LOCAL_MODULE := libVideoDecodeV4l2.so
