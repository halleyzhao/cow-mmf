...
LOCAL_SRC_FILES := $(SRC_PATH)/components/video_sink.cc       \
                   $(SRC_PATH)/components/video_sink_x11.cc

LOCAL_SHARED_LIBRARIES := mmbase cowbase X11
LOCAL_INSTALL_PATH := $(INST_LIB_PATH)/cow

##X11_CPP_LIBS_FLAGS :=-D_ENABLE_X11
##LOCAL_CPPFLAGS += $(X11_CPP_LIBS_FLAGS)
LOCAL_LDFLAGS:=`pkg-config --cflags --libs egl glesv2 libswscale xv`

LOCAL_MODULE := libVideoSinkX11.so
