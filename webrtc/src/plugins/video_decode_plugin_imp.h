...
public:
    ...
    virtual bool InitDecodeContext(woogeen::base::MediaCodec::VideoCodec video_codec, void * surface, int surfaceType = 0/* platform dependent surface type */);
    virtual bool Release();
    virtual bool OnEncodedFrame(std::unique_ptr<woogeen::base::VideoEncodedFrame> & frame);
    virtual VideoDecoderInterface* Copy();

private:
    MediaBufferSP createMediaBuffer(std::unique_ptr<woogeen::base::VideoEncodedFrame> & frame);
