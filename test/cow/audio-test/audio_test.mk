...
LOCAL_SHARED_LIBRARIES += FFmpegComponent AudioSinkPulse cow-avhelper

LOCAL_MODULE := cow-audio-test

LOCAL_SRC_FILES := audio_test.cc

LOCAL_INST_FILES := (eng:$(MULTIMEDIA_BASE)/test/res/audio/sp.mp3:$(INST_TEST_RES_PATH)/sp.mp3)
