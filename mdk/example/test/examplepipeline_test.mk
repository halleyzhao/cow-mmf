...
CPPFLAGS += -D_COW_SOURCE_VERSION=\"$(RELEASE_VERSION)\" -D_APPEND_XML_PATH=\"$(INSTALL_PATH)\"

LIBDIRS := -L../../lib -L$(OUT_PATH)/usr/lib -L$(COW_PLUGIN_PATH)
CPPLDFLAGS  := -lpthread -z defs
CPPLDFLAGS += `pkg-config --cflags --libs libavformat libavcodec libavutil`
CPPLDFLAGS += -lmmbase -lcowbase -lmediaplayer -lcowplayer -lexamplePipeline
OBJS = examplepipeline_test.o
TARGET = examplepipeline-test
